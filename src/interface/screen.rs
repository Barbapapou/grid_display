...
impl Screen {
    pub fn new(shader_program: u32) -> Screen {
        ...
        screen.add_element(lorem_ispum);

        let mut delta_time = Box::new(UiText::new(String::from(""), Vector2::new(1, 1), Vector2::new(10, 1)));
        ...
        screen.add_element(delta_time);

        let mut mouse_pos = Box::new(UiText::new(String::from(""), Vector2::new(0, 3), Vector2::new(30, 1)));
        ...
        screen.add_element(mouse_pos);

        let mut grid_pos = Box::new(UiText::new(String::from(""), Vector2::new(0, 4), Vector2::new(30, 1)));
